    ...
    <div className="w-full h-auto bg-white py-10">
      ...
      <div className="flex flex-col gap-4 px-5 md:px-10">
        <div className="flex flex-wrap justify-between items-center">
          <h1 className="text-3xl md:text-4xl font-playfair">Ongoing Project</h1>
          <Link to='/property'><button className="bg-gray-300 text-[#0C385D] px-4 py-2 rounded-xl flex items-center gap-2 text-sm md:text-base">
            Explore More <IoIosArrowForward />
          </button>
          
          </Link>
        </div>
        <span className="text-gray-600 text-sm md:text-base font-playfair">Lorem ipsum dolor sit amet</span>
      </div>
