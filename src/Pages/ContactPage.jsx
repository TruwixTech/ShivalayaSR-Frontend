      ...
      <div className="w-full flex flex-col md:flex-row justify-center items-center pt-4 md:pt-10 pb-10 md:pb-20 gap-10 ">
        ...
        <div className="bg-[#996433] w-[90%]  rounded-xl flex md:hidden shadow-2xl text-white flex-col gap-4 justify-center px-8 h-[250px] relative z-20">
          ...
          <p className="flex items-center text-sm">
            ...
            shivalaya,Rajnagar Extension Ghaziabad <br /> Ghaziabad
          </p>
          <p className="flex items-center text-sm">
            <span className="mr-2">
              <IoMdMail size={16} />
            </span>{" "}
            shivalayasrgroup@gmail.com
          </p>
        ...
        {/* Contact Us Form */}
        <div
          className="bg-white w-[95%] md:w-[60%] border-2 border-gray-400 flex flex-col md:flex-row items-center relative min-h-[500px] md:min-h-[600px] -top-1"
          style={{
            borderRadius: "20px",
          }}
        >
          ...
          <div
            className="bg-[#996433] hidden md:flex shadow-2xl text-white flex-col gap-8 justify-center px-8 h-[500px] absolute left-[-120px]"
            style={{
                borderRadius: "20px",
            }}
          >
            ...
            <p className="flex items-center">
              ...
              shivalaya,Rajnagar Extension Ghaziabad<br /> 
            </p>
            <p className="flex items-center">
              <span className="mr-2">
                <IoMdMail size={20} />
